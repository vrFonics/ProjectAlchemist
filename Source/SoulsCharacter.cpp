...
void ASoulsCharacter::UpdateCameraState(ECameraState NewState)
{
	...
	UpdateSpringArmSettings(*SpringArmSettingsByCameraState.Find(NewState));
...
void ASoulsCharacter::BeginPlay()
{
	...
	UpdateSpringArmSettings(*SpringArmSettingsByCameraState.Find(CameraMelee));
...
void ASoulsCharacter::UpdateSpringArmSettings(FSpringArmSettings NewSettings)
{
	...
	if (CameraState != CameraRanged || CameraState != CameraZoomed)
	{
...
void ASoulsCharacter::DoLockedCameraRotation()
{
	...
	GetController()->SetControlRotation(LockOnComponent->GetLockedSpringArmRotation(SpringArmComponent->GetComponentLocation()));
}
